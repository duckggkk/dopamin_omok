...
public record PublicUserResponse(
     ...
     * classic/physical/casual 은 null 로 두어 불필요한 집계 쿼리를 피한다.
     */
    public static PublicUserResponse from(User user) {
        return from(user, null, null, null);
    }

    public static PublicUserResponse from(User user, ModeStats classic, ModeStats physical, ModeStats casual) {
