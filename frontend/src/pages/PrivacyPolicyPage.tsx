    ...
    <article className={styles.body}>
      ...
      <section>
        ...
        <ul className={styles.list}>
          ...
          <li>
            탈퇴 시 이메일·비밀번호·프로필 정보 등 회원을 식별할 수 있는 정보는 즉시 파기되며, 계정은
            다시 이용할 수 없습니다. 다만 <strong>이미 종료된 대국 기록은 함께 대국한 상대방의 전적·기보에
            해당하는 정보이므로 삭제되지 않으며</strong>, 해당 기록에서 회원은 &lsquo;탈퇴한 사용자&rsquo;로만
            표시되어 개인을 식별할 수 없습니다.
          </li>
          <li>
            <strong>
      ...
      <section>
        ...
        <ul className={styles.list}>
          ...
          <li>
            <strong>회원 탈퇴(계정 삭제)는 프로필 화면의 &lsquo;계정 관리 &gt; 회원 탈퇴&rsquo;에서 직접
            처리할 수 있으며</strong>, 요청 즉시 개인정보가 파기됩니다.
          </li>
          <li>
            그 밖의 권리 행사를 원하거나 탈퇴가 정상적으로 처리되지 않는 경우 아래 보호책임자 연락처로
            요청하실 수 있으며, 운영자는 지체 없이 조치합니다.
          </li>
        </ul>
      </section>
